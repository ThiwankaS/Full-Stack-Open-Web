...
const BlogDisplay = ({ list,deleteRecord }) => {
    return (
        <>
        <div className="pl-5 max-w-max h-auto">
            ...
            <div key={record.id} className="mt-2 border-t border-black-100">
                <dl className="divide-y divide-gray-100">
                    ...
                    <button className="mt-3 rounded-md bg-gray-800 mr-3 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Update</button>
